...
public class Superstructure {
  ...
  public Command runFlywheel(double percent) {
    return new StartEndCommand(
    () -> turret_.setFlywheelPercent(percent),
    () -> turret_.stopFlywheel(),
    turret_);
  }
  ...
  public Command jogHoodUp() {
    return new StartEndCommand(
    () -> turret_.setHoodPercent(Constants.kHoodJogPercent),
    () -> turret_.stopHood(),
    turret_);
  }
  ...
  public Command setHoodPosition(double position) {
    ...
    () -> turret_.setHoodPosition(position),
    turret_)
  ...
  public Command jogRotationLeft() {
    return new StartEndCommand(
    () -> turret_.setRotationPercent(-Constants.kRotationJogPercent),
  ...
  public Command setRotationPosition(double position) {
    return new RunCommand(
    () -> turret_.setRotationPosition(position),
    turret_)
    .until(() -> turret_.isRotationAtTarget());
  }

  public Command autoAim(java.util.function.DoubleSupplier visionTarget, java.util.function.BooleanSupplier hasTarget) {
    return new RunCommand(
    () -> {
